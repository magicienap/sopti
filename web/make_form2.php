...
<div class="option_block">
	...
	<p><input name="order" type="radio" value="maxfreedays"> Maximiser le nombre de jours de congé <a href="javascript:void(0);" onmouseover="return overlib('Affiche en premier les horaires qui <b>le plus de jours sans cours</b>.');" onmouseout="return nd();"><img style="border: none;" src="qmark.png" alt="Point d'intérogation pour aide contextuelle"></a></p>
